...
@objc
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        ...
        if loginTextField.text == "Rayen" && passwordTextField.text == "root" {
        return true }
        
        let alert = UIAlertController(title: "Ошибка", message: "Проверьте верны ли логин и пароль", preferredStyle: .alert)
